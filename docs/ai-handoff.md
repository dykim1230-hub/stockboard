...
| 작업 환경 | macOS. 백엔드는 push → Render 자동배포. GEMINI_API_KEY Render 환경변수에 설정 완료 |
| 내용 | 뉴스레터 AI 요약 기능 추가 — Gemini 2.5 Flash로 종목별 투자 의견(5문장) + 기사별 뉴스 요약(4문장) 생성. 구글 Generative AI SDK(google-genai) 사용. force=true 강제 발송 파라미터 추가. |
